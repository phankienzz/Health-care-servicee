...
<html lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="css/maps/styles.css">
        <style>
            /* Định vị icon chat */
            #chat-icon {
                display: flex;
                ...
                width: 60px; /* Kích thước khung chứa icon */
                height: 60px;
                position: fixed;
                bottom: 20px;
                right: 20px;
                ...
                z-index: 1000;
                border-radius: 50%;
                background: #009efb; /* Nền để icon dễ nhìn */
        ...
        <jsp:include page="headerCustomer.jsp"></jsp:include>
            ...
            <section class="section clients">
                ...
                <div id="chat-icon" onclick="toggleChat()">
                    <img src="images/service/bubble-chat.png" alt="Chat">
                </div>
                ...
                <div class="chat-input">
                    <input type="text" id="message" placeholder="Nhập tin nhắn..." onkeypress="sendMsg(event)">
            ...
            <script>
                function toggleChat() {
                    ...
                    if (chatContainer.style.display === "none" || chatContainer.style.display === "") {
                        ...
                        chatIcon.style.display = "block"; // Hiện icon
                    }
                }
            </script>
            <script>
                ...
                ws.onmessage = function (event) {
                    ...
                    chatBox.innerHTML += `<div class="message-received">${event.data}</div><br/>`;
                ...
                function sendMsg(event) {
                    if (event && event.key !== "Enter")
                        return; // Gửi tin nhắn khi nhấn Enter

                    let msgInput = document.getElementById("message");
                    let msg = msgInput.value.trim();
                    let username = "<%= session.getAttribute("username")%>"; // Lấy username từ session

                    if (msg) {
                        let fullMessage = `<strong>${username}:</strong> ${msg}`;

                        // Gửi qua WebSocket
                        ws.send(fullMessage);

                        // Hiển thị ngay tin nhắn gửi lên màn hình
                ...
                // Hàm lưu tin nhắn vào cơ sở dữ liệu bằng `fetch()`
                function saveMessageToDB(username, msg) {
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "SaveMessageServlet", true);  // Thay saveMessageServlet với URL servlet của bạn
                    ...
                    // Gửi dữ liệu tin nhắn và username tới servlet
