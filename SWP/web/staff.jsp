            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="staff.html"><i class="fa fa-user"></i> <span> Staff </span> <span
                                    class=""></span></a>
                        </li>
                        <li class="submenu">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-Staff.html" class="btn btn-primary float-right btn-rounded"><i
                                                ...
                                                <c:forEach var="role" items="${listRole}">
                                                    <c:if test="${role.roleID == staff.roleID}">
                                                        <c:if test="${staff.status == 'Active'}">
                                                            <span
                                                                class="custom-badge status-green">${role.roleName}</span>
                                                        </c:if>
                                                        <c:if test="${staff.status == 'Inactive'}">
                                                            <span
                                                                class="custom-badge status-red">${role.roleName}</span>
                                                        </c:if>
                                                    </c:if>
                                                </c:forEach>
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="editStaff?staffID=${staff.staffID}"><i
                                                                class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#delete_employee" data-id="${staff.staffID}"><i
