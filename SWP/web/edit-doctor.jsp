            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="edit-doctor.jsp"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                        </li>
                        <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="dateOfBirth" value="<%= professional != null ? professional.getDOB() : ""%>">
                                    </div>
                                </div>
