                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    <h3 class="user-name m-t-0 mb-0">${customerProfile.fullName}</h3>
                                            ...
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    <li>
                                                        ...
                                                        <span class="text"><a href="#">${customerProfile.phone}</a></span>
                                                    </li>
                                                    <li>
                                                        <span class="title">Email:</span>
                                                        <span class="text"><a href="#">${customerProfile.email}</a></span>
                                                    </li>
                                                    <li>
                                                        <span class="title">Birthday:</span>
                                                        <span class="text">${customerProfile.dateOfBirth}</span>
                                                    </li>
                                                    <li>
                                                        <span class="title">Address:</span>
                                                        <span class="text">${customerProfile.address}</span>
                                                    </li>
                                                    <li>
                                                        <span class="title">Gender:</span>
                                                        <span class="text">${customerProfile.gender}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
