...
public class AppointmentFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AppointmentFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AppointmentFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("AppointmentFilter:doFilter()");
        }
        ...
        if (session.getAttribute("staffAccount") != null) {
            ...
            for (Permission p : list) {
                if (p.getPermissionID() == 2) {
                    canAdd = true;
                }
                if (p.getPermissionID() == 1) {
                    canView = true;
                }
                if (p.getPermissionID() == 3) {
                    canEdit = true;
                }
            }
            if ((uri.contains("manage_appointment") || uri.contains("manage_appointment.jsp")) && !canView) {
                res.sendRedirect("errorPermission.jsp");
            }
            if ((uri.contains("edit_appointment") || uri.contains("edit_appointment.jsp")) && !canEdit) {
                res.sendRedirect("errorPermission.jsp");
            }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AppointmentFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AppointmentFilter(");
