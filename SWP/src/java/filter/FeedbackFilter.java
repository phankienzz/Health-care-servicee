 ...
 * @author Gigabyte
 */
@WebFilter(filterName="FeedbackFilter", urlPatterns={"/feedback","/view-feedback.jsp"})
public class FeedbackFilter implements Filter {
	...
	if (debug) log("FeedbackFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("FeedbackFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("FeedbackFilter:doFilter()");
	...
	HttpServletRequest req = (HttpServletRequest) request;
        ...
        if (session.getAttribute("staffAccount") != null) {
            ...
            if ((uri.contains("view-feedback.jsp") || uri.contains("feedback") ) && !canAdd) {
                res.sendRedirect("errorPermission.jsp");
            }
	...
	if (filterConfig == null) return ("FeedbackFilter()");
