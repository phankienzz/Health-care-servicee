...
public class RoleFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session.getAttribute("staffAccount") != null) {
            ...
            if ((uri.contains("rolePermission") || uri.contains("roles-permissions.jsp") || uri.contains("addRole") 
             || uri.contains("deleteRole") || uri.contains("editRole") || uri.contains("edit-role.jsp") || uri.contains("add-role.jsp") ) && !can) {
                res.sendRedirect("errorPermission.jsp");
            }
        }
