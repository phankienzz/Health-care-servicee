...
public class Iconstant {
    ...
    public static String GOOGLE_REDIRECT_URI = "http://localhost:9999/SWP/GoogleLoginServlet";

    public static String GOOGle_REDIRECT_URI2 = "http://localhost:9999/SWP/RegisterGoogleServlet";
